...
================================================= */
  ...
  $(".single-price-plan").on("mouseenter", function () {
    $(this)
      .addClass("active active-1 text-light-2")
      .parent()
      .siblings()
      .find(".single-price-plan ")
      .removeClass("active active-1 text-light-2");
...
//   });
  ...
  //   $(".icon-animate").on("mouseenter", function () {
  //     $(this)
  //       .addClass("shape shape4 rotate3d")
  //       .parent()
  //       .siblings()
  //       .find("icon-animate")
  //       .removeClass("shape shape4 rotate3d");
  //   });
  $(".icon-animate").hover(
    function () {
      $(this).addClass("shape shape4 rotate3d");
    },
    function () {
      $(this).removeClass("shape shape4 rotate3d");
    }
  );
  /*=====================================================
    13: partner carousel
